...
# handle_homogeneous(data=[['1,2,3'],['2,3,4']],params={"min_support":0.5,"min_confidence":0.5},user_project_analysis_files_dir='D:\\Coding\\Python\\databaseAPI\\app\\users\\data\\1-user0\\2021-08-02-13-30-34--104-sa\\504-homogeneous方法分析结果')
